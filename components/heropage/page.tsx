...
function HeroPage() {
  return (
    <div className='grid grid-cols-1 xl:grid-cols-2 justify-between'>
      <div className=' bg-white flex items-center justify-center lx:justify-end'>
        <div className='flex flex-col justify-between gap-y-10'>
          <h1 className='font-semibold h-[148px] w-[648px] text-[#1D2026] text-[72px] leading-[74px] -tracking-2'>
            Learn with expert anytime anywhere
          </h1>
          <p className='text-[#4E5566] text-[24px] leading-8 h-16 w-[648px]'>
